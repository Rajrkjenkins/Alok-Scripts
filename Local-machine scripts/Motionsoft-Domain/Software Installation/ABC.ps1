# This is for installing softwares in new VM-machines through any Jump-server(Dont use this script from Jenkins)

# Befor running this script need to do Below tasks.

# task: You dont have to put your username and password again and again so Pls Run "GetCredentials" script which is in same folder.
...
ForEach ($Item in $Autocsv)
{
   ...
   $creds = New-Object System.Management.Automation.PSCredential ("motionsoft\asingh",$Password)
